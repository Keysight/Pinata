...
#define asm_pointwise_montgomery MLDSA_NAMESPACE(asm_pointwise_montgomery)
void asm_pointwise_montgomery(int32_t c[N], const int32_t a[N], const int32_t b[N]);
#define asm_pointwise_acc_montgomery MLDSA_NAMESPACE(asm_pointwise_acc_montgomery)
